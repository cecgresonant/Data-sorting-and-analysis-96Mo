// Script to compare all h_e_de_bXfX ring by ring to check the calibration
// Cecilie, April 1 :D , 2020 
// Last update: Aug 16, 2021

#include <fstream>
#include <iostream>

void script_h_e_de_comparison_96Mo(){
    // No stats or titles shown
    gStyle->SetOptStat(0);
    gStyle->SetOptTitle(0);

    // Grab data file for 96Mo(p,p')
    TFile *file = TFile::Open("Mo96_sirical.root");

    // Back detector 0
	TH2D *h_ede_b0f0  = (TH2D*)file->Get("h_e_de_b0f0"); // Delta E + E histogram for b0f0
    TH2D *h_ede_b0f1  = (TH2D*)file->Get("h_e_de_b0f1"); // Delta E + E histogram for b0f1
    TH2D *h_ede_b0f2  = (TH2D*)file->Get("h_e_de_b0f2"); // Delta E + E histogram for b0f2
    TH2D *h_ede_b0f3  = (TH2D*)file->Get("h_e_de_b0f3"); // Delta E + E histogram for b0f3
    TH2D *h_ede_b0f4  = (TH2D*)file->Get("h_e_de_b0f4"); // Delta E + E histogram for b0f4
    TH2D *h_ede_b0f5  = (TH2D*)file->Get("h_e_de_b0f5"); // Delta E + E histogram for b0f5
    TH2D *h_ede_b0f6  = (TH2D*)file->Get("h_e_de_b0f6"); // Delta E + E histogram for b0f6
    TH2D *h_ede_b0f7  = (TH2D*)file->Get("h_e_de_b0f7"); // Delta E + E histogram for b0f7

    // Back detector 1
    TH2D *h_ede_b1f0  = (TH2D*)file->Get("h_e_de_b1f0"); // Delta E + E histogram for b1f0
    TH2D *h_ede_b1f1  = (TH2D*)file->Get("h_e_de_b1f1"); // Delta E + E histogram for b1f1
    TH2D *h_ede_b1f2  = (TH2D*)file->Get("h_e_de_b1f2"); // Delta E + E histogram for b1f2
    TH2D *h_ede_b1f3  = (TH2D*)file->Get("h_e_de_b1f3"); // Delta E + E histogram for b1f3
    TH2D *h_ede_b1f4  = (TH2D*)file->Get("h_e_de_b1f4"); // Delta E + E histogram for b1f4
    TH2D *h_ede_b1f5  = (TH2D*)file->Get("h_e_de_b1f5"); // Delta E + E histogram for b1f5
    TH2D *h_ede_b1f6  = (TH2D*)file->Get("h_e_de_b1f6"); // Delta E + E histogram for b1f6
    TH2D *h_ede_b1f7  = (TH2D*)file->Get("h_e_de_b1f7"); // Delta E + E histogram for b1f7

    // Back detector 2
    TH2D *h_ede_b2f0  = (TH2D*)file->Get("h_e_de_b2f0"); // Delta E + E histogram for b2f0
    TH2D *h_ede_b2f1  = (TH2D*)file->Get("h_e_de_b2f1"); // Delta E + E histogram for b2f1
    TH2D *h_ede_b2f2  = (TH2D*)file->Get("h_e_de_b2f2"); // Delta E + E histogram for b2f2
    TH2D *h_ede_b2f3  = (TH2D*)file->Get("h_e_de_b2f3"); // Delta E + E histogram for b2f3
    TH2D *h_ede_b2f4  = (TH2D*)file->Get("h_e_de_b2f4"); // Delta E + E histogram for b2f4
    TH2D *h_ede_b2f5  = (TH2D*)file->Get("h_e_de_b2f5"); // Delta E + E histogram for b2f5
    TH2D *h_ede_b2f6  = (TH2D*)file->Get("h_e_de_b2f6"); // Delta E + E histogram for b2f6
    TH2D *h_ede_b2f7  = (TH2D*)file->Get("h_e_de_b2f7"); // Delta E + E histogram for b2f7

    // Back detector 3
    TH2D *h_ede_b3f0  = (TH2D*)file->Get("h_e_de_b3f0"); // Delta E + E histogram for b3f0
    TH2D *h_ede_b3f1  = (TH2D*)file->Get("h_e_de_b3f1"); // Delta E + E histogram for b3f1
    TH2D *h_ede_b3f2  = (TH2D*)file->Get("h_e_de_b3f2"); // Delta E + E histogram for b3f2
    TH2D *h_ede_b3f3  = (TH2D*)file->Get("h_e_de_b3f3"); // Delta E + E histogram for b3f3
    TH2D *h_ede_b3f4  = (TH2D*)file->Get("h_e_de_b3f4"); // Delta E + E histogram for b3f4
    TH2D *h_ede_b3f5  = (TH2D*)file->Get("h_e_de_b3f5"); // Delta E + E histogram for b3f5
    TH2D *h_ede_b3f6  = (TH2D*)file->Get("h_e_de_b3f6"); // Delta E + E histogram for b3f6
    TH2D *h_ede_b3f7  = (TH2D*)file->Get("h_e_de_b3f7"); // Delta E + E histogram for b3f7

    // Back detector 4
    TH2D *h_ede_b4f0  = (TH2D*)file->Get("h_e_de_b4f0"); // Delta E + E histogram for b4f0
    TH2D *h_ede_b4f1  = (TH2D*)file->Get("h_e_de_b4f1"); // Delta E + E histogram for b4f1
    TH2D *h_ede_b4f2  = (TH2D*)file->Get("h_e_de_b4f2"); // Delta E + E histogram for b4f2
    TH2D *h_ede_b4f3  = (TH2D*)file->Get("h_e_de_b4f3"); // Delta E + E histogram for b4f3
    TH2D *h_ede_b4f4  = (TH2D*)file->Get("h_e_de_b4f4"); // Delta E + E histogram for b4f4
    TH2D *h_ede_b4f5  = (TH2D*)file->Get("h_e_de_b4f5"); // Delta E + E histogram for b4f5
    TH2D *h_ede_b4f6  = (TH2D*)file->Get("h_e_de_b4f6"); // Delta E + E histogram for b4f6
    TH2D *h_ede_b4f7  = (TH2D*)file->Get("h_e_de_b4f7"); // Delta E + E histogram for b4f7

    // Back detector 5
    TH2D *h_ede_b5f0  = (TH2D*)file->Get("h_e_de_b5f0"); // Delta E + E histogram for b5f0
    TH2D *h_ede_b5f1  = (TH2D*)file->Get("h_e_de_b5f1"); // Delta E + E histogram for b5f1
    TH2D *h_ede_b5f2  = (TH2D*)file->Get("h_e_de_b5f2"); // Delta E + E histogram for b5f2
    TH2D *h_ede_b5f3  = (TH2D*)file->Get("h_e_de_b5f3"); // Delta E + E histogram for b5f3
    TH2D *h_ede_b5f4  = (TH2D*)file->Get("h_e_de_b5f4"); // Delta E + E histogram for b5f4
    TH2D *h_ede_b5f5  = (TH2D*)file->Get("h_e_de_b5f5"); // Delta E + E histogram for b5f5
    TH2D *h_ede_b5f6  = (TH2D*)file->Get("h_e_de_b5f6"); // Delta E + E histogram for b5f6
    TH2D *h_ede_b5f7  = (TH2D*)file->Get("h_e_de_b5f7"); // Delta E + E histogram for b5f7

    // Back detector 6
    TH2D *h_ede_b6f0  = (TH2D*)file->Get("h_e_de_b6f0"); // Delta E + E histogram for b6f0
    TH2D *h_ede_b6f1  = (TH2D*)file->Get("h_e_de_b6f1"); // Delta E + E histogram for b6f1
    TH2D *h_ede_b6f2  = (TH2D*)file->Get("h_e_de_b6f2"); // Delta E + E histogram for b6f2
    TH2D *h_ede_b6f3  = (TH2D*)file->Get("h_e_de_b6f3"); // Delta E + E histogram for b6f3
    TH2D *h_ede_b6f4  = (TH2D*)file->Get("h_e_de_b6f4"); // Delta E + E histogram for b6f4
    TH2D *h_ede_b6f5  = (TH2D*)file->Get("h_e_de_b6f5"); // Delta E + E histogram for b6f5
    TH2D *h_ede_b6f6  = (TH2D*)file->Get("h_e_de_b6f6"); // Delta E + E histogram for b6f6
    TH2D *h_ede_b6f7  = (TH2D*)file->Get("h_e_de_b6f7"); // Delta E + E histogram for b6f7

    // Back detector 7
    TH2D *h_ede_b7f0  = (TH2D*)file->Get("h_e_de_b7f0"); // Delta E + E histogram for b7f0
    TH2D *h_ede_b7f1  = (TH2D*)file->Get("h_e_de_b7f1"); // Delta E + E histogram for b7f1
    TH2D *h_ede_b7f2  = (TH2D*)file->Get("h_e_de_b7f2"); // Delta E + E histogram for b7f2
    TH2D *h_ede_b7f3  = (TH2D*)file->Get("h_e_de_b7f3"); // Delta E + E histogram for b7f3
    TH2D *h_ede_b7f4  = (TH2D*)file->Get("h_e_de_b7f4"); // Delta E + E histogram for b7f4
    TH2D *h_ede_b7f5  = (TH2D*)file->Get("h_e_de_b7f5"); // Delta E + E histogram for b7f5
    TH2D *h_ede_b7f6  = (TH2D*)file->Get("h_e_de_b7f6"); // Delta E + E histogram for b7f6
    TH2D *h_ede_b7f7  = (TH2D*)file->Get("h_e_de_b7f7"); // Delta E + E histogram for b7f7

    double centroid_Qkinz_f0 = 15306.3;
    double centroid_Qkinz_f1 = 15313.4;
    double centroid_Qkinz_f2 = 15320.6;
    double centroid_Qkinz_f3 = 15328.0;
    double centroid_Qkinz_f4 = 15335.5;
    double centroid_Qkinz_f5 = 15343.0;
    double centroid_Qkinz_f6 = 15350.6;
    double centroid_Qkinz_f7 = 15358.2;
    ...
    TCanvas *c1 = new TCanvas("c1","c1:f0 histograms",700,600);
    c1->cd();
    ...
    h_ede_b0f0->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f0->GetYaxis()->SetRangeUser(0,6000);
    h_ede_b0f0->GetYaxis()->SetTitle("counts");
    h_ede_b0f0->Draw();
    h_ede_b0f0->Fit("gaus","","",15100,15500);
    ...
    h_ede_b1f0->Fit("gaus","","",15100,15500);
    ...
    h_ede_b2f0->SetLineColor(kGreen+1);
    h_ede_b2f0->Draw("same");
    h_ede_b2f0->Fit("gaus","","",15100,15500);
    ...
    h_ede_b3f0->Fit("gaus","","",15100,15500);    
    ...
    h_ede_b4f0->Fit("gaus","","",15100,15500);    
    ...
    h_ede_b5f0->Fit("gaus","","",15100,15500);    
    ...
    h_ede_b6f0->SetLineColor(kYellow+2);
    h_ede_b6f0->Draw("same");
    h_ede_b6f0->Fit("gaus","","",15100,15500);    
    ...
    h_ede_b7f0->Fit("gaus","","",15100,15500);    
    ...
    leg_f0->AddEntry(h_ede_b0f0," h_e_de_b0f0 ","L");
    leg_f0->AddEntry(h_ede_b1f0," h_e_de_b1f0 ","L");
    leg_f0->AddEntry(h_ede_b2f0," h_e_de_b2f0 ","L");
    leg_f0->AddEntry(h_ede_b3f0," h_e_de_b3f0 ","L");
    leg_f0->AddEntry(h_ede_b4f0," h_e_de_b4f0 ","L");
    leg_f0->AddEntry(h_ede_b5f0," h_e_de_b5f0 ","L");
    leg_f0->AddEntry(h_ede_b6f0," h_e_de_b6f0 ","L");
    leg_f0->AddEntry(h_ede_b7f0," h_e_de_b7f0 ","L");
    leg_f0->Draw();

    c1->Update();
    c1->Print("h_e_de_f0_96Mo.png");

    // Calculate difference of Qkinz value and the fit of the elastic peak
    // Note that there is very likely a deadlayer on the E detector,
    // which is not taken into account in the Qkinz calculations
    ...
    // Make canvas to plot the histograms
    TCanvas *c2 = new TCanvas("c2","c2:f1 histograms",700,600);
    c2->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f1->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f1->GetYaxis()->SetRangeUser(0,8000);
    h_ede_b0f1->GetYaxis()->SetTitle("counts");
    h_ede_b0f1->Draw();
    h_ede_b0f1->Fit("gaus","","",15150,15500);
    ...
    h_ede_b1f1->Fit("gaus","","",15150,15500);
    ...
    h_ede_b2f1->Fit("gaus","","",15150,15500);
    ...
    h_ede_b3f1->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b4f1->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b5f1->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b6f1->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b7f1->Fit("gaus","","",15150,15500);    
    ...
    leg_f1->AddEntry(h_ede_b0f1," h_e_de_b0f1 ","L");
    leg_f1->AddEntry(h_ede_b1f1," h_e_de_b1f1 ","L");
    leg_f1->AddEntry(h_ede_b2f1," h_e_de_b2f1 ","L");
    leg_f1->AddEntry(h_ede_b3f1," h_e_de_b3f1 ","L");
    leg_f1->AddEntry(h_ede_b4f1," h_e_de_b4f1 ","L");
    leg_f1->AddEntry(h_ede_b5f1," h_e_de_b5f1 ","L");
    leg_f1->AddEntry(h_ede_b6f1," h_e_de_b6f1 ","L");
    leg_f1->AddEntry(h_ede_b7f1," h_e_de_b7f1 ","L");
    leg_f1->Draw();

    c2->Update();
    c2->Print("h_e_de_f1_96Mo.png");
    ...
    // Make canvas to plot the histograms
    TCanvas *c3 = new TCanvas("c3","c3:f2 histograms",700,600);
    c3->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f2->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f2->GetYaxis()->SetRangeUser(0,10000);
    h_ede_b0f2->GetYaxis()->SetTitle("counts");
    h_ede_b0f2->Draw();
    h_ede_b0f2->Fit("gaus","","",15150,15500);
    ...
    h_ede_b1f2->Fit("gaus","","",15150,15500);
    ...
    h_ede_b2f2->Fit("gaus","","",15150,15500);
    ...
    h_ede_b3f2->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b4f2->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b5f2->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b6f2->Fit("gaus","","",15150,15500);    
    ...
    h_ede_b7f2->Fit("gaus","","",15150,15500);    
    ...
    // Make canvas to plot the histograms
    TCanvas *c4 = new TCanvas("c4","c4:f3 histograms",700,600);
    c4->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f3->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f3->GetYaxis()->SetRangeUser(1,10000);
    h_ede_b0f3->GetYaxis()->SetTitle("counts");
    h_ede_b0f3->Draw();
    h_ede_b0f3->Fit("gaus","","",15200,15500);
    ...
    h_ede_b1f3->Fit("gaus","","",15200,15500);
    ...
    h_ede_b2f3->Fit("gaus","","",15200,15500);
    ...
    h_ede_b3f3->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b4f3->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b5f3->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b6f3->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b7f3->Fit("gaus","","",15200,15500);    
    ...
    // Make canvas to plot the histograms
    TCanvas *c5 = new TCanvas("c5","c5:f4 histograms",700,600);
    c5->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f4->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f4->GetYaxis()->SetRangeUser(1,12000);
    h_ede_b0f4->GetYaxis()->SetTitle("counts");
    h_ede_b0f4->Draw();
    h_ede_b0f4->Fit("gaus","","",15200,15500);
    ...
    h_ede_b1f4->Fit("gaus","","",15200,15500);
    ...
    h_ede_b2f4->Fit("gaus","","",15200,15500);
    ...
    h_ede_b3f4->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b4f4->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b5f4->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b6f4->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b7f4->Fit("gaus","","",15200,15500);    
    ...
    // Make canvas to plot the histograms
    TCanvas *c6 = new TCanvas("c6","c6:f5 histograms",700,600);
    c6->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f5->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f5->GetYaxis()->SetRangeUser(1,13000);
    h_ede_b0f5->GetYaxis()->SetTitle("counts");
    h_ede_b0f5->Draw();
    h_ede_b0f5->Fit("gaus","","",15200,15500);
    ...
    h_ede_b1f5->Fit("gaus","","",15200,15500);
    ...
    h_ede_b2f5->Fit("gaus","","",15200,15500);
    ...
    h_ede_b3f5->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b4f5->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b5f5->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b6f5->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b7f5->Fit("gaus","","",15200,15500);    
    ...
    // Make canvas to plot the histograms
    TCanvas *c7 = new TCanvas("c7","c7:f6 histograms",700,600);
    c7->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f6->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f6->GetYaxis()->SetRangeUser(1,14000);
    h_ede_b0f6->GetYaxis()->SetTitle("counts");
    h_ede_b0f6->Draw();
    h_ede_b0f6->Fit("gaus","","",15200,15500);
    ...
    h_ede_b1f6->Fit("gaus","","",15200,15500);
    ...
    h_ede_b2f6->Fit("gaus","","",15200,15500);
    ...
    h_ede_b3f6->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b4f6->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b5f6->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b6f6->Fit("gaus","","",15200,15500);    
    ...
    h_ede_b7f6->Fit("gaus","","",15200,15500);    
    ...
    // Make canvas to plot the histograms
    TCanvas *c8 = new TCanvas("c8","c8:f7 histograms",700,600);
    c8->cd();
    gPad->SetBottomMargin(0.13);
    gPad->SetLeftMargin(0.14);
    gPad->SetRightMargin(0.03);
    ...
    h_ede_b0f7->GetXaxis()->SetRangeUser(10000,16100);
    h_ede_b0f7->GetYaxis()->SetRangeUser(0,14000);
    h_ede_b0f7->GetYaxis()->SetTitle("counts");
    h_ede_b0f7->Draw();
    h_ede_b0f7->Fit("gaus","","",15250,15600);
    ...
    h_ede_b1f7->Fit("gaus","","",15250,15600);
    ...
    h_ede_b2f7->Fit("gaus","","",15250,15600);
    ...
    h_ede_b3f7->Fit("gaus","","",15250,15600);    
    ...
    h_ede_b4f7->Fit("gaus","","",15250,15600);    
    ...
    h_ede_b5f7->Fit("gaus","","",15250,15600);    
    ...
    h_ede_b6f7->Fit("gaus","","",15250,15600);    
    ...
    h_ede_b7f7->Fit("gaus","","",15250,15600);    
